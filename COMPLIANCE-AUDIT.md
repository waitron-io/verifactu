...
| Validation §3.1.3.16–17: total cross-checks allow €10 and exclude regimes `03`, `05`, `06`, `08`, `09` | `CUOTA_TOTAL_MISMATCH` and `IMPORTE_TOTAL_MISMATCH` warnings, skipped for those regimes | Tolerance boundary, exemption and mixed-regime cases in `src/validate.test.ts` | Mixed-regime records retain an advisory warning; AEAT's mixed-line handling needs a live check |
